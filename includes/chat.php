...
<div class="row">
    <div class="col-md-4">
        <div class="card card-dark card-outline">
            ...
            <div class="card-body p-2">
                ...
                <div id="chatContactsList" style="max-height: 650px; overflow-y: auto;"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-8">
        <div class="card card-dark card-outline">
            <div class="card-header">
                <h3 class="card-title" id="chatThreadTitle">Vyber kolegu</h3>
            </div>

            <div class="card-body p-3" id="chatMessages" style="height: 550px; overflow-y: auto; background: #1f2d3d;">
...
function renderChatHeader(user) {
    ...
    let photo = user.photo ? ('images/' + user.photo) : 'images/profile.jpg';
    ...
    let statusLabel = user.status_label || 'Unknown';
    let statusIcon = user.status_icon || 'fa-question';
        ...
        success: function(res) {
            ...
            if (!res.contacts || !res.contacts.length) {
                ...
                res.contacts.forEach(function(user) {
                    ...
                    html += `
                        <div class="chat-contact ${statusBg}" 
...
function openDmWithUser(userId, userName) {
    $.ajax({
