...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div id="sidebarMenu" class="sidebar">
    ...
    <nav class="mt-2 nav-compact auto-collapse">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column nav-treeview" id="menu-open-orders" data-widget="treeview"
        ...
        <li class="nav-item <?= isMenuOpen([
          ...
          ?>
        <li class="nav-item">
          <a href="<?= basename($_SERVER['PHP_SELF']) ?>?page=holidays" class="nav-link <?= isActive('holidays') ?>">
            <i class="nav-icon far fa-calendar-check" style="color:#17a2b8;"></i>
            <p>Holidays</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?= basename($_SERVER['PHP_SELF']) ?>?page=projects" class="nav-link <?= isActive('projects') ?>">
        ...
        <li class="nav-item <?= isMenuOpen([
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item"><a href="<? echo basename($_SERVER['PHP_SELF']); ?>?page=modeldata"
                class="nav-link <?= isActive('modeldata') ?>"><i class="fa fa-caret-right nav-icon"></i>
                <p>Compatibility Chart</p>
              </a></li>
            <li class="nav-item"><a href="<? echo basename($_SERVER['PHP_SELF']); ?>?page=product_chart"
                class="nav-link <?= isActive('product_chart') ?>"><i class="fa fa-caret-right nav-icon"></i>
                <p>Models Database</p>
              </a></li>            
          </ul>
        </li>
        <li class="nav-item <?= isMenuOpen([
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item"><a href="<? echo basename($_SERVER['PHP_SELF']); ?>?page=product_listing_catalog"
                class="nav-link <?= isActive('product_listing_catalog') ?>"><i class="fa fa-caret-right nav-icon"></i>
        ...
        <li class="nav-item <?= isMenuOpen([
          ...
          <a href="#" class="nav-link" style="background-color:#2a3036;"><i class="nav-icon fas fa-globe-africa"
        ...
        <li class="nav-item menu-open"><a href="#" class="nav-link" style="background-color:#2a3036;"><i
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item <?= isMenuOpen([
              ...
              <a href="#" class="nav-link" style="background-color:#2a3036;"><i class="fas fa-chart-bar nav-icon"
                  style="color:#ffc107;"></i>
            ...
            <li class="nav-item <?= isMenuOpen([
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item"><a href="?page=plastics_orders_active"
                    class="nav-link <?= isActive('plastics_orders_active') ?>"><i
                ...
                <li class="nav-item"><a href="?page=plastics_orders_all"
