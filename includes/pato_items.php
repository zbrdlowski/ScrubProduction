...
<section class="content">
  ...
  <input type="hidden" name="page" value="pato_items">
  ...
  <div class="row">
    ...
    <div class="col-md-2"><input type="text" name="scrubcode" class="form-control" placeholder="Scrubcode" value="<?= htmlspecialchars($_GET['scrubcode'] ?? '') ?>"></div>
  ...
  <div class="row" style="margin-top:10px;">
    ...
    <div class="col-md-2">
      <a href="index.php?page=pato_items" class="btn btn-secondary btn-block">Reset</a>
    </div>
  </div>
</form>
        ...
        <div class="mb-3 p-3 border bg-light">
          ...
          <table class="table table-sm table-borderless mb-0">
              <tbody>
                ...
                <tr><th>Scrubcode</th><td id="detail_scrubcode"></td></tr>
