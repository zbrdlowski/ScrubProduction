...
<div class="panel panel-info">
  ...
  <div class="panel-body">
    <form method="GET" action="index.php" class="form-inline">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div class="form-group">
            <input type="text" name="order_id" class="form-control" placeholder="Order No." value="<?= htmlspecialchars($_GET['order_id'] ?? '') ?>">
        </div>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div class="form-group">
            <input type="text" name="item_name" class="form-control" placeholder="Item Barcode" value="<?= htmlspecialchars($_GET['item_name'] ?? '') ?>">
        </div>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div class="form-group">
            <input type="text" name="shelf_name" class="form-control" placeholder="Shelf" value="<?= htmlspecialchars($_GET['shelf_name'] ?? '') ?>">
        </div>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <div class="form-group">
        ...
        <a href="index.php?page=historical_movements" class="btn btn-warning"><i class="fa fa-refresh"></i> Reset</a>
    </form>
  </div>
</div>
<br /><br/>
  ...
  <tbody>
    <?php while ($r = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
      <tr class="<?= $r['movement_type'] === 'IN' ? 'success' : 'danger' ?>">
        <td data-order="<?= date('Y-m-d', strtotime($r['timestamp'])) ?>"><?= date("d.m.Y H:i", strtotime($r['timestamp'])) ?></td>
