...
<h2 class="text-center">📦 Scan Item In</h2>
        ...
        <div class="panel-body">
          <form id="scanForm" method="POST">
            <div class="form-group">
              <input type="hidden" id="movement" name="movement" value="IN" required>  
            </div>
            ...
            <div style="position:relative;">
              <input type="text"
                    ...
                    id="order_id"
                    name="order_id"
                    value="<?= isset($_SESSION['saved_order']) ? htmlspecialchars($_SESSION['saved_order']) : '' ?>" required>
              <span id="clearOrder"
            ...
            <button type="submit" class="btn btn-success btn-block" style="color:black;">🚀 ZASKLADNIŤ</button>
          </form>
        </div>
      </div>
    </div>
