...
$result = $conn->query("SELECT *, DATE_FORMAT(date,'%d.%m.%Y') AS niceDate FROM orders_".$append." WHERE NOT status = 'Shipped' AND NOT status = 'Delivered' ORDER BY status DESC");
$r = array();
