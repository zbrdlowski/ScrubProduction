...
/**
 * install_status_policies_2026_09.php
 * ---------------------------------------------------------
 * UPSERT install skript pre aktualizovanu sadu status policies
 * vratane Plastics Check Stock gate a samostatneho INFO_REQUIRED
 * overall statusu pre tvrde item blockery.
 *
 * POUZITIE: nahraj do scripts/orders/ a spusti RAZ cez browser
 * (ako admin) alebo cez CLI: php install_status_policies_2026_09.php
 *
...
$requiredStatusDefinitions = [
    ...
    ['order', null, 'INFO_REQUIRED', 'Info required', '#dc3545', 44],
];
...
$policies = [
    ...
    [
        ...
        'stop' => 1,
        'conditions' => [
            ['S', 'status', 'IN', ['MODEL_REQUIRED', 'IMG_REQUIRED', 'N_N_REQUIRED']],
        ],
    ],
    [
        ...
        'stop' => 1,
        'conditions' => [
            ['P', 'status', 'IN', ['MODEL_REQUIRED', 'IMG_REQUIRED', 'N_N_REQUIRED']],
        ],
    ],
    [
